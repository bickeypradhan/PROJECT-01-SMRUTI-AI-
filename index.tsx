  ...
  return (
    <div className="h-full flex relative w-full overflow-hidden bg-white dark:bg-slate-950">
      ...
      <div className="flex-1 flex flex-col relative min-w-0 h-full">
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 sm:px-6 pt-6 sm:pt-8 pb-44 sm:pb-56 space-y-12 no-scrollbar">
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-xl z-[100] flex items-center justify-center p-4">
      <div className="w-full max-w-4xl max-h-[85dvh] flex flex-col bg-white dark:bg-slate-950 rounded-[2rem] shadow-2xl overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-12 space-y-12">{versions.map((v: any) => (
...
const App = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-white dark:bg-slate-950 min-h-[100dvh] md:h-screen overflow-hidden font-sans transition-colors duration-500 selection:bg-slate-900 dark:selection:bg-slate-100 selection:text-white dark:selection:text-slate-900">
      ...
      <main className="flex-1 min-h-[100dvh] md:h-screen overflow-hidden flex flex-col relative bg-white dark:bg-slate-950">
